    ...
    <div id="sidebar"
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <x-nav-item title="Dashboard" route="dashboard" icon='<path class="fill-current @if (in_array(Request::segment(1), ['dashboard'])) {{ 'text-indigo-500' }}@else{{ 'text-slate-400' }} @endif" d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z" /><path class="fill-current @if (in_array(Request::segment(1), ['dashboard'])) {{ 'text-indigo-600' }}@else{{ 'text-slate-600' }} @endif" d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z" /><path class="fill-current @if (in_array(Request::segment(1), ['dashboard'])) {{ 'text-indigo-200' }}@else{{ 'text-slate-400' }} @endif" d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z" />' :sub-items="[
                        ['title' => 'Main', 'route' => 'dashboard'],
                        ['title' => 'Analytics', 'route' => 'analytics'],
                        ['title' => 'Fintech', 'route' => 'fintech']
                    ]" />
                    <!-- Finance -->
