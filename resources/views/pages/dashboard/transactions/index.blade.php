    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mb-5">
            <ul class="flex flex-wrap -m-1">
                ...
                <li class="m-1" style="margin-left: 20px">
                    <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-white text-slate-500 duration-150 ease-in-out">{{ $transactionsTotal }}</button>
                </li>
