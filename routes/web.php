...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('dashboard')->group(function () {
        Route::get('/', [DashboardController::class, 'index'])->name('dashboard.index'); // Main Dashboard
        Route::get('/transfer', [DashboardController::class, 'transfer'])->name('dashboard.transfer'); // Transfer Page
        Route::get('/payment-method', [DashboardController::class, 'paymentMethod'])->name('dashboard.payment-method'); // Payment Methods Page

        Route::prefix('transactions')->group(function () {
            Route::get('/', [DashboardController::class, 'transactions'])->name('dashboard.transactions'); // Transaction History (All)
            Route::get('/transfers', [DashboardController::class, 'transferHistory'])->name('dashboard.transactions.transfers'); // Transfer History
            Route::get('/deposits', [DashboardController::class, 'depositHistory'])->name('dashboard.transactions.deposits'); // Deposit History
            Route::get('/withdrawals', [DashboardController::class, 'withdrawalHistory'])->name('dashboard.transactions.withdrawals'); // Withdrawal History
        });

        Route::prefix('loans')->group(function () {
            Route::get('/', [DashboardController::class, 'loans'])->name('dashboard.loans'); // Loans Main Page / Loan Plans
            Route::get('/request-loan', [DashboardController::class, 'requestLoan'])->name('dashboard.loans.request-loan'); // Request Loan Page
            Route::get('/loan-history', [DashboardController::class, 'loanHistory'])->name('dashboard.loans.loan-history'); // Loan History Page
            Route::get('/{loan}', [DashboardController::class, 'loanDetails'])->name('dashboard.loans.details'); // Specific Loan Details Page - Route Parameter for Loan ID
        });

        Route::get('/referrals', [DashboardController::class, 'referrals'])->name('dashboard.referrals'); // Referrals Page

        Route::prefix('investments')->group(function () {
            Route::get('/', [DashboardController::class, 'myHoldings'])->name('dashboard.investments'); // My Holdings Page
            Route::get('/market-data', [DashboardController::class, 'marketData'])->name('dashboard.investments.market-data'); // Market Data Page
        });

        Route::prefix('insights')->group(function () {
            Route::get('/', [DashboardController::class, 'spendingAnalysis'])->name('dashboard.insights'); // Spending Analysis Page
            Route::get('/funds-management', [DashboardController::class, 'fundsManagement'])->name('dashboard.insights.funds-management'); // Funds Management Page (Budgeting)
        });

        Route::get('/notifications', [DashboardController::class, 'notifications'])->name('dashboard.notifications'); // Notifications Page

        Route::get('/account', [DashboardController::class, 'account'])->name('dashboard.account'); // Profile Page
        Route::get('/settings', [DashboardController::class, 'settings'])->name('dashboard.settings'); // Settings Page
    });
});
